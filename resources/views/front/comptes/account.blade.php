                                ...
                                <nav class="axil-dashboard-nav">
                                    <div class="nav nav-tabs" role="tablist">
                                        ...
                                        <a class="nav-item nav-link" data-bs-toggle="tab" href="#nav-downloads"
                                            role="tab" aria-selected="false"><i class="fas fa-file-download"></i>
                                            ...
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col">
                                                            {{ \App\Helpers\TranslationHelper::TranslateText('Trasport') }}
                                                        </th>
                                                        <th scope="col">
                                                    ...
                                                    @forelse ($commandes as $key => $commande)
                                                        <tr>
                                                            ...
                                                            <td data-label="Order ID">
                                                                {{ $commande->montant() - $commande->coupon ?? '' }}
                                                            ...
                                                            <td data-label="Status" class="text-green">
                                                                ...
                                                                @switch($commande->statut)
                                                                    ...
                                                                    @default
                                                                        <span
                                                                            class="badge bg-secondary">{{ ucfirst($commande->statut) }}</span>
                                                                @endswitch
                                                                {{-- {{ $commande->statut }} --}}
                                                            </td>
                                                            <td>
                                                            ...
                                                            <span>Facture</span>
                                                               ...
                                                               {{--  <a href="{{ route('print_commande', ['id' => $commande->id]) }}"
                                                                ...
                                                                <a href="{{ route('commande_print', $commande->id) }}"
                                                                    target="_blank" class="btn btn-success">
                                                                   
                                                                     {{ \App\Helpers\TranslationHelper::TranslateText(' 🖨️ Facture') }}
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        @empty
